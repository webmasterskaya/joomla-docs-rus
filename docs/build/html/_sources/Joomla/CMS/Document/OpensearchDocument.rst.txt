...
.. php:class:: OpensearchDocument
    ...
    .. php:method:: setShortName($name)

        Sets the short name

        :param $name:
        :returns: OpensearchDocument instance of $this to allow chaining

    .. php:method:: addUrl(OpensearchUrl $url)

        Adds a URL to the Opensearch description.

        :type $url: OpensearchUrl
        :param $url:
        :returns: OpensearchDocument instance of $this to allow chaining

    .. php:method:: addImage(OpensearchImage $image)

        Adds an image to the Opensearch description.

        :type $image: OpensearchImage
        :param $image:
        :returns: OpensearchDocument instance of $this to allow chaining
