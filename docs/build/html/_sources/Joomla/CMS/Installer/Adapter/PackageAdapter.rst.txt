...
.. php:class:: PackageAdapter

    Package installer

    .. php:attr:: installedIds
    ...
    .. php:method:: onExtensionAfterInstall(Installer $installer, $eid)
    ...
    .. php:method:: _getExtensionId($type, $id, $client, $group)
