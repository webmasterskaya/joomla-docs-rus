...
.. php:class:: User
    ...
    .. php:method:: load($userId = null, $reset = true)
    ...
    .. php:method:: check()
        ...
        :returns: boolean True if satisfactory
    ...
    .. php:method:: setLastVisit($timeStamp = null, $userId = null)
