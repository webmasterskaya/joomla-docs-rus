-----------------------------------
Joomla\\CMS\\Form\\Field\\UserField
-----------------------------------
...
.. php:class:: UserField
    ...
    .. php:method:: getGroups()
        ...
        :returns: mixed Array of filtering groups or null.

    .. php:method:: getExcluded()

        Method to get the users to exclude from the list of users

        :returns: mixed Array of users to exclude or null to to not exclude them
