...
.. php:class:: CMSApplication
    ...
    .. php:method:: getMenu($name = null, $options = array())
    ...
    .. php:method:: getPathway($name = null, $options = array())

        Returns the application \JPathway object.

        :param $name:
        :param $options:
        :returns: \JPathway|null

    .. php:method:: getRouter($name = null, $options = array())

        Returns the application \JRouter object.

        :param $name:
        :param $options:
        :returns: \JRouter|null
    ...
    .. php:method:: getTemplate($params = false)
        ...
        :param $params:
        :returns: mixed System is the fallback.
    ...
    .. php:method:: login($credentials, $options = array())
        ...
        responsible for the user validation. A successful validation updates the
        current session record with the user's details.
        ...
        :param $credentials:
        :param $options:
        :returns: boolean|\JException True on success, false if failed or silent handling is configured, or a \JException object on authentication error.
