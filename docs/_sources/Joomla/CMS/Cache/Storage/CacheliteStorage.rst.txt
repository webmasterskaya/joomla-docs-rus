...
.. php:class:: CacheliteStorage

    Cache lite storage handler

    .. php:attr:: CacheLiteInstance
    ...
    .. php:method:: initCache($cloptions)

        Instantiates the Cache_Lite object. Only initializes the engine if it does
        not already exist.
