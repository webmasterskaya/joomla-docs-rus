...
.. php:class:: Menu
    ...
    .. php:method:: __construct(JDatabaseDriver $db)
    ...
    .. php:method:: bind($array, $ignore = '')
        ...
        :param $array:
        :param $ignore:
        :returns: mixed Null if operation was satisfactory, otherwise returns an error
    ...
    .. php:method:: store($updateNulls = false)
        ...
        :param $updateNulls:
        :returns: mixed False on failure, positive integer on success.
    ...
    .. php:method:: rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
