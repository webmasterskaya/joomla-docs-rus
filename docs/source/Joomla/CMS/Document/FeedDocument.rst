...
.. php:class:: FeedDocument
    ...
    .. php:method:: addItem(FeedItem $item)

        Adds a FeedItem to the feed.

        :type $item: FeedItem
        :param $item:
        :returns: FeedDocument instance of $this to allow chaining
