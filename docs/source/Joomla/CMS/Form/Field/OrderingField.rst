---------------------------------------
Joomla\\CMS\\Form\\Field\\OrderingField
---------------------------------------

.. php:namespace: Joomla\\CMS\\Form\\Field

.. php:class:: OrderingField
    ...
    .. php:method:: getQuery()
        ...
        :returns: \JDatabaseQuery The query for the ordering form field

    .. php:method:: getItemId()

        Retrieves the current Item's Id.

        :returns: integer The current item ID
