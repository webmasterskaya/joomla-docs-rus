...
.. php:class:: Usergroup
    ...
    .. php:method:: rebuild($parent_id = 0, $left = 0)
    ...
    .. php:method:: store($updateNulls = false)
        ...
        :param $updateNulls:
        :returns: boolean True if successful, false otherwise and an internal error message is set

    .. php:method:: delete($oid = null)
