...
.. php:class:: ModuleAdapter
    ...
    .. php:method:: discover()
        ...
        :returns: array Extension list of extensions available
    ...
    .. php:method:: _rollback_module($arg)
