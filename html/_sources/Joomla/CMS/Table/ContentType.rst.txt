-------------------------------
Joomla\\CMS\\Table\\ContentType
-------------------------------

.. php:namespace: Joomla\\CMS\\Table

.. php:class:: ContentType
    ...
    .. php:method:: fieldmapExpand($assoc = true)
    ...
    .. php:method:: getTypeId($typeAlias)
        ...
        :param $typeAlias:
        :returns: mixed type_id for this alias if successful, otherwise null.

    .. php:method:: getContentTable()

        Method to get the Table object for the content type from the table object.

        :returns: mixed Table object on success, otherwise false.
